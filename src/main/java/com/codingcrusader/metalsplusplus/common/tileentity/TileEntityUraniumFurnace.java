...
import com.codingcrusader.metalsplusplus.common.blocks.BlockUraniumFurnace;
...
public class TileEntityUraniumFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
	/*
	 * This class is mostly copy-pasted from TileEntityFurnace, still working on it.
	 */
	...
	{
		return this.hasCustomName() ? this.furnaceCustomName : "container.uranium_furnace";
	}
	...
	{
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityUraniumFurnace.class, new String[] {"Items"}));
	}
	...
	public void update()
	{
		...
		if (!this.world.isRemote)
		{
			...
			if (this.isBurning() || !itemstack.isEmpty() && !((ItemStack)this.furnaceItemStacks.get(0)).isEmpty())
			{
				...
				{
					this.furnaceBurnTime = getItemBurnTime(itemstack) / 3;
			...
			{
				flag1 = true;
				BlockUraniumFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		}
